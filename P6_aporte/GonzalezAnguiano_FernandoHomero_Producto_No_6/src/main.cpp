...
int valorEntrada5 = 0;
int pinEntrada13 = 13; // Se utilizará la entrada D5 de la Wemos D1
int valorEntrada13 = 0;
int pinEntrada12 = 12; // Se utilizará la entrada D5 de la Wemos D1
int valorEntrada12 = 0;
...
pinMode(pinEntrada13, INPUT); // se prepara como entrada al pin 4
pinMode(pinEntrada12, INPUT); // se prepara como entrada al pin 4
...
cliente.print(" ");
cliente.print("El valor digital de entrada GPIO5 es: ");
cliente.print(valorEntrada5);
Serial.print("contador = "); Serial.println(cont);

// boton en el GPIO3
valorEntrada13 = digitalRead(pinEntrada13); //lectura digital de pin
cliente.print("<br>");
cliente.print(" ");
cliente.print("El valor digital de entrada GPIO 13 es: ");
cliente.print(valorEntrada13);

// boton en el GPIO12
valorEntrada12 = digitalRead(pinEntrada12); //lectura digital de pin
cliente.print("<br>");
cliente.print(" ");
cliente.print("El valor digital de entrada GPIO12 es: ");
cliente.print(valorEntrada12);
delay(5);
cliente.flush();
cliente.stop();
