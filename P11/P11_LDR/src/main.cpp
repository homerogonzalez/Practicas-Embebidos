...
setInterval(actualizaContador, 200); /* La función setInterval y el método setInterval()
Para utilizar la función setInterval, se invoca el método setInterval() y se le pasa la función de
callback y
el retardo como parámetros. Aquí está un ejemplo:
...
especificado.
Retardo es el tiempo en milisegundos que debe transcurrir antes de ejecutar la función de callback.
Por ejemplo, si deseas que una función llamada actualizarDatos() se ejecute cada 5 segundos, se
puede
...
<title>Detector de oscuridad con AJAX</title>
</head>
<body>
<div id='main'>
...
cliente.print("<html>");
if (valorEntradaD5 == 1)
{ cliente.print("<h1> Está oscurecido el ambiente, LED ENCENDIDO </h1>");
digitalWrite(LED_BUILTIN, HIGH); }
else
{ cliente.print("<h1> Hay iluminación en ambiente, LED APAGADO </h1>");
