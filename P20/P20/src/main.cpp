...
int pinEntrada36 = 36; // Se utilizará la entrada IO36 de la Wemos D1 R32
int pinEntrada39 = 39; // Se utilizará la entrada IO39 de la Wemos D1 R32
...
// cliente.print(" ");
int c1 = analogRead(pinEntrada34); // valor análogo
int porc1=c1*100/4095; // porcentaje del valor análogo, ADC de 12 bits 0 a 4095
int c2 = analogRead(pinEntrada36); // valor análogo
int porc2=c2*100/4095; // porcentaje del valor análogo, ADC de 12 bits 0 a 4095
int c3 = analogRead(pinEntrada39); // valor análogo
int porc3=c3*100/4095; // porcentaje del valor análogo, ADC de 12 bits 0 a 4095
cliente.print("<html>");
...
cliente.print( cont );
cliente.print( "</h2>" );
cliente.print("<h2> Valor de la señal análoga 1</h2>");
cliente.print("<h2>");
cliente.print( c1 );
cliente.print("</h2>");
...
cliente.print("<div class='propiedades porcentaje' style='width:");cliente.print(porc1);cliente.print( "%");cliente.print("'>");
cliente.print( porc1);
cliente.print( "%");
cliente.print("</div> <!– porcentaje remplazado ––>");
cliente.print("</div>");

cliente.print("<h2> Valor de la señal análoga 2</h2>");
cliente.print("<h2>");
cliente.print( c2 );
cliente.print("</h2>");
cliente.print("<div class='contenedor'>");
cliente.print("<div class='propiedades porcentaje' style='width:");cliente.print(porc2);cliente.print( "%");cliente.print("'>");
cliente.print( porc2);
cliente.print( "%");
cliente.print("</div> <!– porcentaje remplazado ––>");
cliente.print("</div>");

cliente.print("<h2> Valor de la señal análoga 3</h2>");
cliente.print("<h2>");
cliente.print( c3 );
cliente.print("</h2>");
cliente.print("<div class='contenedor'>");
cliente.print("<div class='propiedades porcentaje' style='width:");cliente.print(porc3);cliente.print( "%");cliente.print("'>");
cliente.print( porc3);
cliente.print( "%");
cliente.print("</div> <!– porcentaje remplazado ––>");
cliente.print("</div>");
